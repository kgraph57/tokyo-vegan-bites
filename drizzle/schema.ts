...
export const veganLevelEnum = pgEnum("vegan_level", ["100% Vegan", "Vegan Options", "Vegetarian", "Contains Fish Broth"]);
export const videoSourceEnum = pgEnum("video_source", ["instagram", "tiktok", "youtube", "upload"]);
...
export const restaurants = pgTable("restaurants", {
  ...
  veganLevel: veganLevelEnum("veganLevel").notNull(),
...
export const menuItems = pgTable("menuItems", {
  ...
  description: text("description"),
  descriptionJa: text("descriptionJa"),
  price: integer("price"), // Price in yen
